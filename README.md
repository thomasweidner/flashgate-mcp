...
| `get_directory_tree` | Returns bounded, field-selectable, paginated directory-tree entries. |
...
When `MCP_READ_ONLY=true`, only `list_directory`, `get_directory_tree`, `read_file`, and `get_path_info` are exposed.
