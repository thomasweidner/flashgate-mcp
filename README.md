...
| `read_files` | Reads an ordered, bounded batch of text files with per-item results. |
...
When `MCP_READ_ONLY=true`, only `list_directory`, `read_file`, `read_files`, and `get_path_info` are exposed.
