...
path binding, and the obsolete dynamic shell form. BL-333 and BL-334 remain
`In Progress` until Hosted CI, PR review, and merge complete; BL-335 remains
