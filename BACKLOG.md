...
interpreter version or package digest. BL-333 and BL-334 remain `In Progress`
until Hosted CI, PR review, and merge complete; BL-335 remains `Planned` and
has not begun.
