...
identity fields. Before indexing either artifact, the loader binds each fixed
baseline filename to its required embedded OS and architecture and rejects swapped
or mislabeled platform contents.
