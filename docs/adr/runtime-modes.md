...
- [ADR-003: Use STDIO Transport](stdio-transport.md)
- [ADR-008: Core Reuse, Deployment, and FlashGate Module/Provider Model](core-reuse.md)
- [ADR-015: Hybrid Service Execution Identity](execution-identity.md)
- [ADR-017: Host Process Ownership and Lifecycle](host-lifecycle.md)
- [Architecture](../architecture.md)
- [Security model](../security.md)
- [Native multi-mode runtime and service plan](../planning/runtime-modes.md)
