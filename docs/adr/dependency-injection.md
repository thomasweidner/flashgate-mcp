...
FlashGate MCP must remain testable, maintainable and extensible.
...
The same dependency boundaries apply to the domain-separated core, optional
Operations/Job Manager, platform adapters, and MCP adapter described by
[ADR-007](domain-core.md) through [ADR-013](mcp-compatibility.md). Planned
components do not become current implementation merely by appearing here.
