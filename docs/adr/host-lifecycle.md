...
legitimate processes whose owners and lifetimes differ. Unexpectedly persistent instances create a quality, security, and diagnostic
risk, but simultaneous processes alone are not proof of orphaning.
...
- a long-lived client app server or wrapper can outlive a logical agent;
...
- [ADR-003](stdio-transport.md)
- [ADR-014](runtime-modes.md)
- [ADR-015](execution-identity.md)
