...
The current deterministic UTF-8 JSONL `tools/list` response, including its trailing newline, is 5951 bytes for read-only and 9474 bytes for default. The older 1239/2134-byte, 3850/5657-byte, 3046/6569-byte, 4271/7794-byte, 4894/8417-byte, and 5594/9117-byte measurements remain historical snapshots, not persistent payload budgets.
