...
The current deterministic UTF-8 JSONL `tools/list` response, including its trailing newline, is 4894 bytes for read-only and 8417 bytes for default. The older 1239/2134-byte, 3850/5657-byte, 3046/6569-byte, and 4271/7794-byte measurements remain historical snapshots, not persistent payload budgets.
