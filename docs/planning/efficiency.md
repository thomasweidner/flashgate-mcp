...
Initial planning budgets are deliberately conservative and must be confirmed by the reproducible benchmark suite:
...
- [Comparative MCP review](efficiency.md)
- [Benchmark documentation](../../benchmarks/README.md)
- [Architecture](../architecture.md)
- [Version 1.0 scope](release-scope.md)
- [ADR-012](../adr/efficiency-contracts.md)
