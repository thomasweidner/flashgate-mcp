...
normalized identity of every icon frame against the committed ICO. Record the exact validated binary and operator confirmation in the validation
report. Visual confirmation is not a substitute for the automated test.
