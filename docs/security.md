...
|---|---:|---|
| `MCP_MAX_FILE_SIZE` | `10485760` | Hard cap for complete and byte-range `read_file` results; client `maxBytes` can only lower it, and offset/head/tail selectors cannot bypass it. |
