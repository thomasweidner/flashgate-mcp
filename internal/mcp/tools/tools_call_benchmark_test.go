...
func (benchmarkParallelFileSystem) EditRange(string, int64, int64, []byte) (int64, error) {
	return 0, nil
}
func (benchmarkParallelFileSystem) EditMatches(string, []byte, []byte, int) (int64, error) {
	return 0, nil
}
