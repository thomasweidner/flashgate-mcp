...
func TestFilesystemCallToolWireSuccesses(t *testing.T) {
	...
	registry := createToolRegistry(filesystem, 1024*1024, toolCapabilities{filesystemRead: true, filesystemWrite: true})
...
func TestFilesystemCallToolWireErrorsRemainSafe(t *testing.T) {
	...
	defaultRegistry := createToolRegistry(filesystem, 1024, toolCapabilities{filesystemRead: true, filesystemWrite: true})
